...
_This work was generated using data from the TERRA REF (_ [_http://terraref.org_](http://terraref.org/)_) experiment, funded by the ARPA-E TERRA program. [field site acknowldgement] [data hosting acknowledgement]_

**Keywords**

Please use the &quot;TERRA REF&quot; as one of your keywords on submitted manuscripts, so that TERRA REF work is easily indexed and searchable.
```
