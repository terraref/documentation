...
We plan to release the data in stages or tiers. For access to unchecked pre-release data, please complete the [beta user application](https://terraref.org/beta).
...
3. The **third tier** will provide the public with access to curated datasets from the TERRA REF program. 
The TERRA-REF team will begin to release data to the public in November 2019. 

Access to all data is granted under the conditions described below.
...
For algorithms, we intend to release via BSD 3 clause or MIT / BSD compatible license. Algorithms are available under active development on GitHub in the terraref organization: github.com/terraref. Versions used to process publicly released data will be tagged with version numbers and releases on GitHub, and archived on Zenodo.
...
* Todd Mockler, Project and Genomics Lead (email: tmockler@danforthcenter.org)
* Nadia Shakoor, Project Director (email: nshakoor@danforthcenter.org)
* David LeBauer, Data and Computing Pipeline Lead (email: dlebauer@email.arizona.edu)
